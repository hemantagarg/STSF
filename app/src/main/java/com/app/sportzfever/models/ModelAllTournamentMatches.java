...
public class ModelAllTournamentMatches implements Serializable{
    ...
    {
        return firstBattingWickets;
    }

    public void setFirstBattingWickets (String firstBattingWickets)
    {
    ...
    {
        return totalRunsScoredTeam2;
    }

    public void setTotalRunsScoredTeam2 (String totalRunsScoredTeam2)
    {
