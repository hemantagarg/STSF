...
public class ModelSearchPeoples {
    ...
    private String hometown, totalComment, dateTime, totalShare, totalLike;
    ...
    private String totalTournament;
    ...
    public String getTotalTournament() {
        return totalTournament;
    }

    public void setTotalTournament(String totalTournament) {
