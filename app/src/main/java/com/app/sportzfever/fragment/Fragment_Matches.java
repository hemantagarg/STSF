 ...
 */
public class Fragment_Matches extends BaseFragment implements ApiResponse {
    ...
    public static Fragment_Matches fragment_team;
    private final String TAG = Fragment_Matches.class.getSimpleName();

    public static Fragment_Matches getInstance() {
        if (fragment_team == null)
            fragment_team = new Fragment_Matches();
