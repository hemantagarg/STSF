 ...
 */
public class Fragment_TeamFeed extends BaseFragment implements ApiResponse, OnCustomItemClicListener {
    ...
    public static Fragment_TeamFeed getInstance() {
        if (fragment_userFeed == null)
            fragment_userFeed = new Fragment_TeamFeed();
    ...
    public void onPostSuccess(int position, JSONObject jObject) {
        try {
            if (position == 1) {
                ...
                String allowedToPost = jObject.getString("allowedToPost");
                if (allowedToPost.equalsIgnoreCase("1"))
                    layout_post_feed.setVisibility(View.VISIBLE);
                else
                    layout_post_feed.setVisibility(View.GONE);
