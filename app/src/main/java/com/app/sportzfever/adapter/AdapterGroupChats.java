 ...
 */
public class AdapterGroupChats extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<ModeJoinedGroup> detail;
    Context mContext;
    ...
    public AdapterGroupChats(Context context, OnCustomItemClicListener lis, ArrayList<ModeJoinedGroup> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ModeJoinedGroup m1 = (ModeJoinedGroup) detail.get(i);

            ((CustomViewHolder) holder).text_name.setText(m1.getName());
           ((CustomViewHolder) holder).text_message.setVisibility(View.GONE);
    ...
    public int getItemViewType(int position) {
        ModeJoinedGroup m1 = (ModeJoinedGroup) detail.get(position);
