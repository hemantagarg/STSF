 ...
 */
public class AdapterLiveMatches extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<ModelLiveMatches> detail;
    Context mContext;
    ...
    public AdapterLiveMatches(Context context, OnCustomItemClicListener lis, ArrayList<ModelLiveMatches> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).textdateofmatch.setText(" Match Scheduled To Start At " + m1.getTime() + " On " + m1.getDate() + "  " + m1.getMonthName() + "  " + m1.getYear());
    ...
    public int getItemViewType(int position) {
        ModelLiveMatches m1 = (ModelLiveMatches) detail.get(position);
