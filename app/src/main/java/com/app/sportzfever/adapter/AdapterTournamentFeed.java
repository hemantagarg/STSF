 ...
 */
public class AdapterTournamentFeed extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterTournamentFeed(Context context, OnCustomItemClicListener lis, ArrayList<ModelFeed> list) {
