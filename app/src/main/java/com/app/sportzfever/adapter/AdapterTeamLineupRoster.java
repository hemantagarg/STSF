 ...
 */
public class AdapterTeamLineupRoster extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterTeamLineupRoster(Context context, OnCustomItemClicListener lis, ArrayList<ModelSportTeamList> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_teamlineuproster, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_name.setText(m1.getPlayerName());
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        TextView text_name, text_speciality, text_avtarname;
