 ...
 */
public class AdapterBattingStats extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterBattingStats(Context context, OnCustomItemClicListener lis, ArrayList<ModelStats> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_batting_stats, parent, false);
