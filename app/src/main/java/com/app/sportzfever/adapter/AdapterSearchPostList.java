 ...
 */
public class AdapterSearchPostList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterSearchPostList(Context context, OnCustomItemClicListener lis, ArrayList<ModelSearchPeoples> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_post.setText(m1.getTotalLike() + " Likes");
            ((CustomViewHolder) holder).text_team.setText(m1.getTotalComment() + " Comments");
            ((CustomViewHolder) holder).text_friends.setText(m1.getTotalShare() + " Shares");
            ...
            ((AdapterSearchPostList.CustomViewHolder) holder).btn_confirm.setOnClickListener(new View.OnClickListener() {
                @Override
