 ...
 */
public class AdapterMyTournament extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterMyTournament(Context context, OnCustomItemClicListener lis, ArrayList<ModelAllTournament> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_mytournaments, parent, false);
