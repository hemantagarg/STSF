 ...
 */
public class AdapterFollowerList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<ModelFollower> detail;
    Context mContext;
    ...
    public AdapterFollowerList(Context context, OnCustomItemClicListener lis, ArrayList<ModelFollower> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((AdapterFollowerList.CustomViewHolder) holder).btn_confirm.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public int getItemViewType(int position) {
        ModelFollower m1 = (ModelFollower) detail.get(position);
