...
public class AdapterHomeFriendSuggestion extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterHomeFriendSuggestion(Context context, OnCustomItemClicListener lis, ArrayList<ModelSportTeamList> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_home_friend_suggestion, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).lblListItem.setText(m1.getAvatarName());
            ((CustomViewHolder) holder).text_location.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            listener.onItemClickListener(getPosition(), 6);
        }
