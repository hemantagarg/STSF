 ...
 */
public class AdapterSearchOppositeTeamList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<ModelSearchOppositeTeam> detail;
    Context mContext;
    OnCustomItemClicListener listener;
    private final int VIEW_ITEM = 1;
    private final int VIEW_PROG = 0;

    public AdapterSearchOppositeTeamList(Context context, OnCustomItemClicListener lis, ArrayList<ModelSearchOppositeTeam> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_search_opposite_teamlist, parent, false);
    ...
    public int getItemViewType(int position) {
        ModelSearchOppositeTeam m1 = (ModelSearchOppositeTeam) detail.get(position);
