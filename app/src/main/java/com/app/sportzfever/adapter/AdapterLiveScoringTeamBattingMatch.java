 ...
 */
public class AdapterLiveScoringTeamBattingMatch extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterLiveScoringTeamBattingMatch(Context context, OnCustomItemClicListener lis, ArrayList<BattingStats> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_scoring_team_batting_match, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            if (m1.isBattingStriker())
                ((CustomViewHolder) holder).image_bat.setVisibility(View.VISIBLE);
            else
                ((CustomViewHolder) holder).image_bat.setVisibility(View.GONE);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView image_avtar, image_bat;
        ...
        public CustomViewHolder(View view) {
            ...
            this.image_bat = (ImageView) view.findViewById(R.id.image_bat);
