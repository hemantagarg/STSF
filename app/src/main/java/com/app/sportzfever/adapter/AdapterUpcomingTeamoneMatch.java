 ...
 */
public class AdapterUpcomingTeamoneMatch extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterUpcomingTeamoneMatch(Context context, OnCustomItemClicListener lis, ArrayList<ModelUpcomingTeamName> list) {
