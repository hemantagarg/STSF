 ...
 */
public class AdapterUpcomingMatches extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterUpcomingMatches(Context context, OnCustomItemClicListener lis, ArrayList<ModelUpcomingMatches> list) {
