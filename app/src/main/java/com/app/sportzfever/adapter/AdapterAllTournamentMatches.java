 ...
 */
public class AdapterAllTournamentMatches extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<ModelAllTournamentMatches> detail;
    Context mContext;
    ...
    public AdapterAllTournamentMatches(Context context, OnCustomItemClicListener lis, ArrayList<ModelAllTournamentMatches> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_alltournamentmatches, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ModelAllTournamentMatches m1 = (ModelAllTournamentMatches) detail.get(i);
         ...
         ((CustomViewHolder) holder).text_event_matchdate.setText(m1.getDate()+" "+m1.getShortMonthName()+" "+m1.getYear()+" "+m1.getTime());
           ...
           ((CustomViewHolder) holder).text_event_type.setText(m1.getStageName());
...
if (m1.getFirstBattingWickets().equalsIgnoreCase("")&&m1.getPlayedOversTeam1().equalsIgnoreCase("")&&m1.getTotalRunsScoredTeam1().equalsIgnoreCase("")){

    ((CustomViewHolder) holder).text_score.setVisibility(View.GONE);
}if (m1.getTotalRunsScoredTeam2().equalsIgnoreCase("")&&m1.getSecondBattingWickets().equalsIgnoreCase("")&&m1.getPlayedOversTeam2().equalsIgnoreCase("")){
...
RelativeLayout relmatchvs;
    ...
    public int getItemViewType(int position) {
        ModelAllTournamentMatches m1 = (ModelAllTournamentMatches) detail.get(position);
