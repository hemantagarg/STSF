...
public class AdapterStats extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
          ...
          ((CustomViewHolder) holder).text_sixfour.setText(m1.getTotalFours()+"/"+m1.getTotalSixes());
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView text_match,text_inns,text_Runs,text_hs,text_SR,text_hundred,text_fifty,text_sixfour,text_Ct,text_St;
