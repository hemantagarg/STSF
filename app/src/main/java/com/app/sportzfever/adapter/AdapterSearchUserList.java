 ...
 */
public class AdapterSearchUserList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterSearchUserList(Context context, OnCustomItemClicListener lis, ArrayList<ModelSearchPeoples> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_search_userlist, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).checkbox.setChecked(m1.ischecked());
