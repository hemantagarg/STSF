 ...
 */
public class AdapterMatchFeed extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterMatchFeed(Context context, OnCustomItemClicListener lis, ArrayList<ModelFeed> list) {
