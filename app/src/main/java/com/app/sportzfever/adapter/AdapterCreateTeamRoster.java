 ...
 */
public class AdapterCreateTeamRoster extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterCreateTeamRoster(Context context, OnCustomItemClicListener lis, ArrayList<ModelSportTeamList> list) {
