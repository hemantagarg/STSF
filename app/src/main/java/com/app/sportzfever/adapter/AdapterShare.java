...
public class AdapterShare extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterShare(Context context, OnCustomItemClicListener lis, ArrayList<ModelShare> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_likes, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ModelShare m1 = (ModelShare) detail.get(i);

            ((CustomViewHolder) holder).text_name.setText(m1.getUserName());

            ((CustomViewHolder) holder).text_date.setText(m1.getShareDateTime());
    ...
    public int getItemViewType(int position) {
        ModelShare m1 = (ModelShare) detail.get(position);
