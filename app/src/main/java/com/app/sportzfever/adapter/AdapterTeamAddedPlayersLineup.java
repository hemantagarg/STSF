 ...
 */
public class AdapterTeamAddedPlayersLineup extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterTeamAddedPlayersLineup(Context context, OnCustomItemClicListener lis, ArrayList<ModelSportTeamList> list) {
