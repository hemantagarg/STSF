 ...
 */
public class AdapterUpcomingTournamentEvent extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterUpcomingTournamentEvent(Context context, OnCustomItemClicListener lis, ArrayList<UpcomingEvent> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_upcomingtournamentevent, parent, false);
