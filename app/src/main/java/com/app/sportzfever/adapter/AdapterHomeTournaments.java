...
public class AdapterHomeTournaments extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterHomeTournaments(Context context, OnCustomItemClicListener lis, ArrayList<ModelSportTeamList> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).text_captain_name.setText("Teams: "+m1.getNoOfTeam());
            ((CustomViewHolder) holder).text_location.setText("Type: "+m1.getType());
