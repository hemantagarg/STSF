 ...
 */
public class AdapterAvtarIPlayOn extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterAvtarIPlayOn(Context context, OnCustomItemClicListener lis, ArrayList<ModelAvtarMyTeam> list) {
