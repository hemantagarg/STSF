 ...
 */
public class AdapterLikes extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<Likes> detail;
    Context mContext;
    ...
    public AdapterLikes(Context context, OnCustomItemClicListener lis, ArrayList<Likes> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            Likes m1 = (Likes) detail.get(i);

            ((CustomViewHolder) holder).text_name.setText(m1.getUserName());

            ((CustomViewHolder) holder).text_date.setText(m1.getLikeDateTime());
    ...
    public int getItemViewType(int position) {
        Likes m1 = (Likes) detail.get(position);
